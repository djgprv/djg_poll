...
<div style="margin: 1em auto; padding: 0.1em;">
	...
	echo '<ul>';
	echo '<li><img width="16px" height="16px" src="' . PLUGINS_URI.'djg_poll/images/16_edit.png' . '" title="'.__('edit').'" alt="'.__('edit').'" /> - ' . __('click to edit poll') . '</li>';	
	echo '<li><img src="' . PLUGINS_URI.'djg_poll/images/16_smile.png' . '" title="'.__('in time').'" alt="'.__('in time').'"> - ' . __('poll is in range of date') . '</li>';	
	echo '<li><img src="' . PLUGINS_URI.'djg_poll/images/16_dead.png' . '" title="'.__('in time').'" alt="'.__('in time').'"> - ' . __('poll is out of date range') . '</li>';	
	echo '<li><img src="' . PLUGINS_URI.'djg_poll/images/16_on.png" title="'.__('activate / deactivate').'" alt="'.__('activate / deactivate').'" /> - ' . __('poll is active') . '</li>';	
	echo '<li><img src="' . PLUGINS_URI.'djg_poll/images/16_off.png" title="'.__('activate / deactivate').'" alt="'.__('activate / deactivate').'" /> - ' . __('poll is inactive') . '</li>';	
	echo '<li><img src="' . PLUGINS_URI.'djg_poll/images/16_del.png' . '" title="'.__('in time').'" alt="'.__('in time').'"> - ' . __('click to remove poll') . '</li>';	
	echo '</ul>';
	?>
